      ...
      <section className="py-32 container mx-auto px-4 animate-antigravity">
        ...
        <div className="mt-32 bg-slate-950 p-12 md:p-20 rounded-antigravity-lg text-center overflow-hidden relative group">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <Button asChild size="lg" className="rounded-2xl h-14 md:h-16 px-10 md:px-14 font-black tracking-[0.1em] md:tracking-[0.2em] [text-indent:0.1em] md:[text-indent:0.2em] bg-white text-black hover:bg-primary hover:text-white transition-all shadow-antigravity active:scale-95 w-full md:w-fit mx-auto flex items-center justify-center">
